  ...
  return (
    <section className="flex flex-col items-center justify-center min-h-[80vh] md:mx-40 mx-10  w-[80vw] bg-gray-100">
      <div className="pt-0 w-9/12 flex flex-row items-center justify-between">
        ...
        <Botton
          preset="mt-2 text-white bg-gradient-to-r from-teal-400 via-teal-500 to-teal-600 hover:bg-gradient-to-br focus:ring-2 focus:outline-none focus:ring-teal-300 dark:focus:ring-teal-800 font-medium rounded-lg text-sm  text-center  px-5 py-1.5 "
          type="text"
          value="Edit"
        />
      </div>
          ...
          {(props) => (
            <Form className="h-[60vh] w-[80vw]  flex flex-col justify-evenly  items-center ">
              <div className=" w-full mt-0 ml-10 flex flex-row">
                ...
                <div className="mr-10">
                  <span
                    className={`md:mr-96 ${!errFile && "hidden"} ${
                      errFile && "text-red-900"
                    }`}
                  >
                    Not supported, try another or leave it!
                  </span>
                </div>
              </div>
