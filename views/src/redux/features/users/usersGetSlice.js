...
export const updateUser = (value) => {
    ...
    return async (dispatch) => {
        ...
        try {
            ...
            if (value.image) {
                console.log("entre")
                uploadedImage = await axios.post("https://api.cloudinary.com/v1_1/leo-echenique/image/upload", value.image);
                newValue = {
                    ...value,
                    image: uploadedImage.data.url
                }
                return await instance.put('http://localhost:3001/user', { newValue })
            }
